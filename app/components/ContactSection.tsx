				...
				>
					...
					<div className="relative z-10">
						...
						<div className="font-mono">
							...
							<motion.a
								href="mailto:rahulch295@gmail.com"
							...
							<motion.a
								href="https://weekend-dev-bucket.s3.eu-north-1.amazonaws.com/Rahul_Chaurasiya_Resume_2025.pdf"
								target="_blank"
							...
							<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
								<motion.a
									href="https://github.com/RahulRazj"
								...
								>
									...
									<div>
										...
										<p className="text-sm text-gray-400">@RahulRazj</p>
									</div>
								</motion.a>
								<motion.a
									href="https://www.linkedin.com/in/rahulrazj"
									whileHover={{ scale: 1.05 }}
									className="flex items-center gap-3 px-4 py-3 bg-gray-800/50 rounded-lg hover:bg-gray-700/50 transition-colors border border-gray-700/50 group"
								>
									<div className="p-2 bg-gray-700/50 rounded-lg group-hover:bg-gray-600/50 transition-colors">
									...
									<div>
										...
										<p className="text-sm text-gray-400">Rahul Chaurasiya</p>
									</div>
								</motion.a>
								<motion.a
									href="https://leetcode.com/RahulRazj"
									whileHover={{ scale: 1.05 }}
									className="flex items-center gap-3 px-4 py-3 bg-gray-800/50 rounded-lg hover:bg-gray-700/50 transition-colors border border-gray-700/50 group"
								>
									<div className="p-2 bg-gray-700/50 rounded-lg group-hover:bg-gray-600/50 transition-colors">
										<svg className="w-5 h-5 text-green-400" fill="currentColor" viewBox="0 0 24 24">
											<path d="M13.483 0a1.374 1.374 0 0 0-.961.438L7.116 6.226l-3.854 4.126a1.653 1.653 0 0 0 0 2.226 1.653 1.653 0 0 0 2.226 0l2.939-3.141 2.939 3.141a1.653 1.653 0 0 0 2.226 0 1.653 1.653 0 0 0 0-2.226l-3.854-4.126 5.406-5.788A1.374 1.374 0 0 0 13.483 0zm-2.276 3.41a1.651 1.651 0 0 0 0 2.226l2.939 3.141-2.939 3.141a1.653 1.653 0 0 0 0 2.226 1.653 1.653 0 0 0 2.226 0l2.939-3.141 2.939 3.141a1.653 1.653 0 0 0 2.226 0 1.653 1.653 0 0 0 0-2.226l-2.939-3.141 2.939-3.141a1.651 1.651 0 0 0 0-2.226 1.653 1.653 0 0 0-2.226 0l-2.939 3.141-2.939-3.141a1.653 1.653 0 0 0-2.226 0z"/>
										</svg>
									</div>
									<div>
